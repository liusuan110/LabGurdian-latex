...
#context {
  ...
  let varrow(up) = box(width: 9pt, height: H)[
    #place(center + horizon, line(start: (0pt, 0pt), end: (0pt, 100%), stroke: 0.9pt + black))
    #if up { place(top + center, polygon(fill: black, (0pt, 0pt), (4pt, 7pt), (-4pt, 7pt))) } else { place(bottom + center, polygon(fill: black, (0pt, 0pt), (4pt, -7pt), (-4pt, -7pt))) }
  ]
  grid(
